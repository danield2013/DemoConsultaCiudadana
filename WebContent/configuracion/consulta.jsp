...
<title>Configuración - Consulta</title>
...
<body>
	...
	<main>
		<section class="section-editor">
			<div class="contenedor">
				<h3 class="text-prin">Consultas</h3>
				<p>Administrar las entradas a consultas publicadas en el sistema.</p>
				<div class="editor-add">
					<span class="icon-add" id="btn-add">
						<span class="text-accion">Editar entrada</span>
					</span>
					...
					<div class="contenedor flex-wrap">
						...
						for (int i = 0; i < 8; i++) {
							...
							<div class="item">
								<table>
									<tr>
										<td rowspan="2" class="item-img"><img src="../img/mapa.jpg" alt=""></td>
										<td class="item-text td-titulo">Título de la consulta</td>
									</tr>
									<tr>
										<td class="item-text td-texto">Instructivo de la consulta</td>
									</tr>
								</table>
							</div>
							<%
